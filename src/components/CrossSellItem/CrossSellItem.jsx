            ...
            {data.data.hits.map(item => (
              <li key={item.attributes.product.attributes.product_id} className="cross-sell-item">
                ...
                <div className='cross-sell-item-info'>
                  ...
                  {/* {item.attributes.product.attributes.product_attributes.shoe_size_eu ? 
                    item.attributes.product.attributes.product_attributes.shoe_size_eu.map(data => (
                      <span className='cross-sell-item-child'>{data}</span>
                    )) : null
                  } */}
